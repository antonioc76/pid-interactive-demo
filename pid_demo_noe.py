...
def update(val):
    ...
    axes.set_ylim((-voltage_slider.valinit, voltage_slider.valinit*2.1))
    
    axes.plot(times, reference_signal, label='Reference signal')
    axes.plot(times, pid_signal, label='PID signal')
